...
class Fonts {
  static const name = "Poppins";
  static final normalStyle = GoogleFonts.poppins(fontWeight: FontWeight.normal);
  static final boldStyle = GoogleFonts.poppins(fontWeight: FontWeight.bold);
}

class FontW {
  static final regular = Fonts.normalStyle.fontWeight;
  static const bold = FontWeight.w600;
  static const max = FontWeight.w900;
}
...
class TextStyles {
  static  TextStyle kDefault = Fonts.boldStyle;
